...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self, mock_json):
        """
        This unit test is for the 'public_repos' method in the GithubOrgClient.
        Testing if the list of repositories matches our expected result based
        on a specific payload.
        Checking if the 'property' and the 'get_json' methods were called once,
        as they are being mocked in this test.
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def tearDownClass(cls):
        """This method is executed after all the tests within
        a class have finished running.
        """
